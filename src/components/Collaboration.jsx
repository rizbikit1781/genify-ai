...
import { check, genify } from '../assets'
    ...
    <Section crosses>
        <div className='container lg:flex'>
            ...
            <div className='lg:ml-auto xl:w-[38rem] mt-4'>
                    ...
                    <div className='rounded-full w-[22rem] border border-n-6 relative left-1/2 flex aspect-square -translate-x-1/2 scale:75 md:scale-100'>
